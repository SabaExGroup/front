...
const SECTION_TITLES: Record<string, string> = {
  ...
  'strategy.manualSell': 'Manual Sell',
  'strategy.manualLiquidityUnlock': 'Manual Liquidity Unlock',
...
const FIELD_HINTS: Record<string, string> = {
  ...
  'integrations.runtime.customLaunch.emergencyLiquidityUnlockSlippageBps': 'Slippage used for owner-liquidity emergency unlock legs on CUSTOM_RAYDIUM pools',
  'integrations.runtime.letsBonk.emergencyLiquidityUnlockSlippageBps': 'Slippage used for owner-liquidity emergency unlock legs on LetsBonk pools',
  ...
  'strategy.emergencyBrake.minPostUnlockPoolLiquiditySol': 'Minimum SOL that must remain in the pool after an owner-liquidity emergency unlock leg — see docs/manual-sell-liquidity-frontend.md §11',
  'strategy.manualSell.enabled': 'Master switch for manual sell (MARKET/TOKEN_OWNER) — disabling returns 409 FEATURE_DISABLED on both endpoints',
  'strategy.manualSell.defaultSlippageBps': 'Used when slippageBps is omitted from the preview request (300 = 3%)',
  'strategy.manualSell.maxPercentPerRequest': 'Upper bound for percent accepted per preview request',
  'strategy.manualLiquidityUnlock.enabled': 'Master switch for manual liquidity unlock (POOL/OWNER/BOTH/AUTO) — disabling returns 409 FEATURE_DISABLED',
  'strategy.manualLiquidityUnlock.defaultSlippageBps': 'Used when slippageBps is omitted from the preview request (300 = 3%)',
  'strategy.manualLiquidityUnlock.maxPercentPerRequest': 'Upper bound for percent accepted per preview request',
